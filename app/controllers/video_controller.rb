class VideoController < ApplicationController
  ...
  def index
    p "!!!!!!!!!!!"
    p params[:file_name]
    @file_name = "/photos/#{params[:file_name]}"
  end
  ...
  def poster_image
    ...
    #   format.html { redirect_to video_index_path(:file_name => file_name, format: :html) }
    # end
    redirect_to video_index_path(:file_name => file_name, format: :html)
  end
